...
func initJaegerTracing(log logrus.FieldLogger) {
	...
	// the collected spans.
	// This appends api/traces by default so you don't need to add that
	// To use this with hypertrace you just need to set JAEGER_SERVICE_ADDR="docker.for.mac.localhost:14268"
